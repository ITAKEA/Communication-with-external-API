package ita.gptdemo.config;

import ita.gptdemo.dto.Gender;
...
public class RemoteApiTester implements CommandLineRunner {
    ...
    List<String> names = Arrays.asList("lars", "peter", "sanne", "kim", "david", "maja", "lars", "peter", "sanne", "kim", "david", "maja", "lars", "peter", "sanne", "kim", "david", "maja");
    ...
    public void run(String... args) throws Exception {
        ...
        //System.out.println(getGenderForName("Claus").block());
        ...
        //System.out.println(callSlowEndpoint().block());
